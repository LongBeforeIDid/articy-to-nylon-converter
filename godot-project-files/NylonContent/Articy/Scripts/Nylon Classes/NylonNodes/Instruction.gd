...
func _run() -> void:
	...
	if addative:
		Articy.add_variable(variable_namespace, variable_name, variable_value)
	elif multiplicative:
		Articy.mult_variable(variable_namespace, variable_name, variable_value)
	else:
		Articy.set_variable(variable_namespace, variable_name, variable_value)
...
func _set_trait(n: String, v: Variant):
	...
	Proarche.player_traits.set(n, v)
